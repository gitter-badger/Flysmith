...
// A range in a descriptor heap.
struct DescriptorTable : D3D12_DESCRIPTOR_RANGE
{
	...
	DescriptorTable(DescriptorTableType, U32 numDescriptors, U32 baseShaderRegister, U32 offset, U32 registerSpace = 0);
};